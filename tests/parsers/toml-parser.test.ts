...
describe('ConfigParser', () => {
  ...
  it('should parse package with optional cargo workspace field', async () => {
    const configPath = join(testDir, 'cargo-workspace.toml');
...
`;
    await writeFile(configPath, cargoConfig);

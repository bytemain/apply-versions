...
describe('PackageTypeValidator', () => {
	...
	it('should validate rust package type', async () => {
	...
	it('should reject invalid package type', async () => {
		...
		expect(result.error).toContain('Valid types are: npm, go, rust');
	});
...
describe('VersionFormatValidator', () => {
	...
	it('should validate semantic versions', async () => {
		const validVersions = ['1.0.0', '0.1.0', '10.20.30', '1.0.0-alpha', '1.0.0+build'];
	...
	it('should reject invalid version formats', async () => {
		const invalidVersions = ['1.0', '1', '1.0.0.0', 'v1.0.0', '1.0.0-', 'latest', 'invalid'];

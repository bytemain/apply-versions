...
describe('GitOperations', () => {
	...
	describe('stageAndCommit', () => {
		...
		it('should stage and commit file', async () => {
			...
			const result = await gitOps.stageAndCommit(pkg, filePath, oldVersion, newVersion, false);
		...
		it('should handle dry run mode', async () => {
			const result = await gitOps.stageAndCommit(pkg, filePath, oldVersion, newVersion, true);
